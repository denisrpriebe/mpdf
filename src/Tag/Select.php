...
class Select extends Tag
{
    ...
    public function open($attr, &$ahtml, &$ihtml)
    {
        ...
        if (isset($properties['WIDTH'])) {
            $this->mpdf->selectoption['WIDTH'] = $this->sizeConverter->convert($properties['WIDTH'], $this->mpdf->blk[$this->mpdf->blklvl]['inner_width']);
        }
        if (isset($properties['HEIGHT'])) {
            $this->mpdf->selectoption['HEIGHT'] = $this->sizeConverter->convert($properties['HEIGHT'], $this->mpdf->blk[$this->mpdf->blklvl]['inner_width']);
        }
...
//		}
        ...
        if (isset($this->mpdf->selectoption['WIDTH'])) {
            $objattr['width'] = $this->mpdf->selectoption['WIDTH'];
        }
        if (isset($this->mpdf->selectoption['HEIGHT'])) {
            $objattr['height'] = $this->mpdf->selectoption['HEIGHT'];
        }
