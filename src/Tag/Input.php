	...
	public function open($attr, &$ahtml, &$ihtml)
	{
		...
		switch (strtoupper($attr['TYPE'])) {
			...
			case 'CHECKBOX': //Draw Checkbox
                ...
                if (isset($properties['WIDTH'])) {
                    $width = $this->sizeConverter->convert($properties['WIDTH'], $this->mpdf->blk[$this->mpdf->blklvl]['inner_width']);
                }
                if (isset($properties['HEIGHT'])) {
                    $height = $this->sizeConverter->convert($properties['HEIGHT'], $this->mpdf->blk[$this->mpdf->blklvl]['inner_width']);
                }
